    ...
    return (
        <div className="w-[90%] m-[auto] max-w-[1100px]">
            ...
            <div className="w-[90%] max-w[600px] m-[auto]">
                ...
                {pokemon.data && (
                    <div className="max-w-sm rounded-[20px] overflow-hidden shadow dark:bg-gray-800 dark:border-gray-700 p-[16px] m-[auto]">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-[20px] gap-y-[30px]">
                                ...
                                <div className="flex gap-2 justify-start sm:justify-end mt-[16px]">
                                    {pokemon.data.types.map((item) => {
                                        ...
                                        return (
                                            <span className={`badge-type-${item.type.name} px-[14px] capitalize py-1 rounded-[12px]`}>{item.type.name}</span>
                                        )
                                    })}
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-[10px] mt-[16px]">
                                        {pokemon.data.stats.map((item) => {
                                            return (
                                                <div className="flex ap-x-[10px] justify-between">
